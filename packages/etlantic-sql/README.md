...
```bash
pip install 'etlantic-sql==0.52.1'
...
[SQL tutorial](https://etlantic.readthedocs.io/en/v0.52.1/06_EXECUTION/SQL_TUTORIAL/) ·
[SQL hello](https://etlantic.readthedocs.io/en/v0.52.1/06_EXECUTION/SQL_HELLO_PYPI/) ·
