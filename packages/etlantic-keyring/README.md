...
[ETLantic](https://github.com/eddiethedean/etlantic) 0.52 using the Python
...
[Secrets documentation](https://etlantic.readthedocs.io/en/v0.52.0/06_EXECUTION/SECRETS_MANAGEMENT/) ·
