...
[ETLantic](https://github.com/eddiethedean/etlantic) 0.39 using the Python
...
[Secrets documentation](https://etlantic.readthedocs.io/en/v0.39.0/06_EXECUTION/SECRETS_MANAGEMENT/) ·
