...
[ETLantic](https://github.com/eddiethedean/etlantic) 0.49 using the Python
...
[Secrets documentation](https://etlantic.readthedocs.io/en/v0.49.0/06_EXECUTION/SECRETS_MANAGEMENT/) ·
