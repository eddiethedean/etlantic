...
[ETLantic](https://github.com/eddiethedean/etlantic) 0.43 using the Python
...
[Secrets documentation](https://etlantic.readthedocs.io/en/v0.43.0/06_EXECUTION/SECRETS_MANAGEMENT/) ·
