...
[ETLantic](https://github.com/eddiethedean/etlantic) 0.37 using the Python
...
[Secrets documentation](https://etlantic.readthedocs.io/en/v0.37.0/06_EXECUTION/SECRETS_MANAGEMENT/) ·
