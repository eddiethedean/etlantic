...
Package version is **0.52.1** — pin with core.

## Install

```bash
pip install 'etlantic-sqlmodel==0.52.1'
...
[Optional packages](https://etlantic.readthedocs.io/en/v0.52.1/10_REFERENCE/OPTIONAL_PACKAGES/) ·
