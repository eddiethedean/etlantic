...
pip install 'etlantic-pandas[arrow]==0.49.0'
...
[Pandas tutorial](https://etlantic.readthedocs.io/en/v0.49.0/06_EXECUTION/PANDAS_TUTORIAL/) ·
[Compatibility](https://etlantic.readthedocs.io/en/v0.49.0/10_REFERENCE/COMPATIBILITY/) ·
