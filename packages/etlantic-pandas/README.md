...
```bash
pip install 'etlantic-pandas==0.52.1'
# Optional Arrow interchange:
pip install 'etlantic-pandas[arrow]==0.52.1'
...
[Pandas tutorial](https://etlantic.readthedocs.io/en/v0.52.1/06_EXECUTION/PANDAS_TUTORIAL/) ·
[Compatibility](https://etlantic.readthedocs.io/en/v0.52.1/10_REFERENCE/COMPATIBILITY/) ·
