...
class DataFusionPlugin:
    ...
    def materialize(self, *args: Any, **kwargs: Any) -> Any:
        raise NotImplementedError(
            "etlantic-datafusion is an experimental stub as of 0.33.0; "
    ...
    def to_records(
        ...
        raise NotImplementedError(
            "etlantic-datafusion to_records is ungraduated as of 0.33.0"
        )
    ...
    def from_records(
        ...
        raise NotImplementedError(
            "etlantic-datafusion from_records is ungraduated as of 0.33.0"
        )
