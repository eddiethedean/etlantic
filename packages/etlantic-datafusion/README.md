...
Version **0.52.1** (provisional implementation; lockstep with ETLantic core).
...
[Capabilities](https://etlantic.readthedocs.io/en/v0.52.1/01_GETTING_STARTED/CAPABILITIES/) ·
