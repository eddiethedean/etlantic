...
_CURATED: dict[str, Any] = {
    ...
    "InferenceReplayError": InferenceReplayError,
    "InferenceLimits": InferenceLimits,
    "InferenceObservation": InferenceObservation,
    "InferenceResult": InferenceResult,
    "OutputProposal": OutputProposal,
    "ReplayHandle": ReplayHandle,
    "ResolvedFileSource": ResolvedFileSource,
    "SchemaEvidence": SchemaEvidence,
    "TargetObservation": TargetObservation,
    "WriteCompatibility": WriteCompatibility,
    "InferredDataset": InferredDataset,
    "infer_records": infer_records,
    "infer_records_for_target": infer_records_for_target,
    "infer_records_for_target_async": infer_records_for_target_async,
    "infer_source": infer_source,
    "infer_source_async": infer_source_async,
    "model_from_schema": model_from_schema,
    ...
    "unregister_file_source": unregister_file_source,
    "unregister_source_factory": unregister_source_factory,
    "validate_source_binding": validate_source_binding,
    "validate_target_binding": validate_target_binding,
    "from_pandas": from_pandas,
    "from_polars": from_polars,
    "infer_csv": infer_csv,
    "infer_json": infer_json,
    "inspect_target": inspect_target,
    "inspect_target_async": inspect_target_async,
    "solve_backward_constraints": solve_backward_constraints,
    "backfill_schema": backfill_schema,
    "check_write_compatibility": check_write_compatibility,
    "forward_schema": forward_schema,
    "infer_expression": infer_expression,
    "infer_frame_schema": infer_frame_schema,
