...
| Version | Support |
|---|---|
| 0.25.x | Current supported Beta line; security fixes are released on this line |
| 0.24.x and earlier | Not actively maintained; upgrade to 0.25.x |

Backports to older minor lines are not provided. Upgrade to the latest 0.25.x
