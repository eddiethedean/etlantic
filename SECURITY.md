...
| Version | Support |
|---|---|
| 0.38.x | Current supported Beta line; security fixes are released on this line |
| 0.37.x | Not actively maintained; upgrade to 0.38.x |
| 0.36.x | Not actively maintained; upgrade to 0.38.x |
| 0.35.x | Not actively maintained; upgrade to 0.38.x |
| 0.34.x | Not actively maintained; upgrade to 0.38.x |
| 0.33.x | Not actively maintained; upgrade to 0.38.x |
| 0.28.x–0.32.x | Not actively maintained; upgrade to 0.38.x |
| 0.27.x and earlier | Not actively maintained; upgrade to 0.38.x |

Backports to older minor lines are not provided. Upgrade to the latest 0.38.x
