...
| Version | Support |
|---|---|
| 0.31.x | Current supported Beta line; security fixes are released on this line |
| 0.27.x and earlier | Not actively maintained; upgrade to 0.31.x |

Backports to older minor lines are not provided. Upgrade to the latest 0.31.x
