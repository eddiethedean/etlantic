...
ETLantic 0.53.0 is the **current Beta release candidate** suitable for documented
...
| Version | Support |
|---|---|
| 0.53.x | Current supported Beta line; security fixes are released on this line |
| 0.52.x | Previous Beta line; upgrade to 0.53.x |
| 0.49.x and earlier | Not actively maintained; upgrade to the current line |

Backports to older minor lines are not provided. Upgrade to the latest 0.53.x
