...
> **Status: Available in ETLantic 0.53.0 (Beta release candidate).** The companion script is exercised
> by CI.
...
Clone a matching release checkout (prefer the `v0.53.0` tag) and use `uv`:
