...
> **Status: Available in ETLantic 0.52.0 (published Beta).** The companion script is exercised
> by CI.
...
Clone a matching release checkout (prefer the `v0.52.0` tag) and use `uv`:
