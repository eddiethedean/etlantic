...
> **Status: ETLantic 0.51.0 release candidate; publication pending.** The companion script is exercised
> by CI.
...
Clone a matching release checkout (prefer the `v0.51.0` tag) and use `uv`:
