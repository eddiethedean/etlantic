...
!!! warning "Design study—not a runnable ETLantic 0.29 API guide. Prefer CAPABILITIES and examples/."
...
[API reference](../10_REFERENCE/API_REFERENCE.md) for 0.25 applications.
