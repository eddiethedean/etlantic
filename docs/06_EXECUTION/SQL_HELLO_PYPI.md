...
> **Status: Available in ETLantic 0.48.0.** Paste-ready SQLite demo — no
...
[`examples/sql_hello_pypi.py`](https://github.com/eddiethedean/etlantic/blob/v0.48.0/examples/sql_hello_pypi.py).

## 1. Install

```bash
python -m pip install 'etlantic[sql]==0.48.0'
```
...
curl -fsSL -o sql_hello.py \
  https://raw.githubusercontent.com/eddiethedean/etlantic/v0.48.0/examples/sql_hello_pypi.py
python sql_hello.py
```
