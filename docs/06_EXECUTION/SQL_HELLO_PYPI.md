...
[`examples/sql_hello_pypi.py`](https://github.com/eddiethedean/etlantic/blob/v0.35.0/examples/sql_hello_pypi.py).
...
curl -fsSL -o sql_hello.py \
  https://raw.githubusercontent.com/eddiethedean/etlantic/v0.35.0/examples/sql_hello_pypi.py
python sql_hello.py
```
