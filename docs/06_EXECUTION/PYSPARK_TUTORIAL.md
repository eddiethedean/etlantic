...
> **Status: Available in ETLantic 0.40.0.** Structured Streaming remains
> experimental.
...
```bash
python -m pip install 'etlantic==0.40.0' 'etlantic-pyspark==0.40.0'
...
```bash
python -m pip install 'etlantic-pyspark[delta]==0.40.0'
