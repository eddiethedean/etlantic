...
> **Status: ETLantic 0.51.0 release candidate; publication pending.** Structured Streaming remains
> experimental.
...
```bash
python -m pip install 'etlantic==0.51.0' 'etlantic-pyspark==0.51.0'
...
```bash
python -m pip install 'etlantic-pyspark[delta]==0.51.0'
