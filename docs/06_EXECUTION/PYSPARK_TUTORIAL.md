...
> **Status: Available in ETLantic 0.45.0.** Structured Streaming remains
> experimental.
...
```bash
python -m pip install 'etlantic==0.45.0' 'etlantic-pyspark==0.45.0'
git clone --branch v0.45.0 https://github.com/eddiethedean/etlantic.git
cd etlantic
...
```bash
python -m pip install 'etlantic-pyspark[delta]==0.45.0'
