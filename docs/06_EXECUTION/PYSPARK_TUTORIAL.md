...
> **Status: Available in ETLantic 0.35.0.** Structured Streaming remains
> experimental.
...
```bash
python -m pip install 'etlantic==0.35.0' 'etlantic-pyspark==0.35.0'
git clone --branch v0.35.0 https://github.com/eddiethedean/etlantic.git
cd etlantic
...
```bash
python -m pip install 'etlantic-pyspark[delta]==0.35.0'
