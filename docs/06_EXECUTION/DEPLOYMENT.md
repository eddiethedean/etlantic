...
> **Status: Available in ETLantic 0.24.0.** This guide describes the bounded,
...
runtime. ETLantic 0.24 does not coordinate a multi-worker runtime.
...
1. Install `etlantic-prefect==0.24.0`.
...
ETLantic 0.24 does not claim a multi-worker or multi-tenant control plane.
