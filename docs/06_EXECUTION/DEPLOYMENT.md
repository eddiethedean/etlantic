...
> **Status: Available in ETLantic 0.38.0.** This guide describes the bounded,
...
| Multi-worker / multi-tenant control plane | Not included in 0.38; planned first-class |
...
runtime. ETLantic 0.38 does not coordinate a multi-worker runtime.
...
1. Install `etlantic-prefect==0.38.0`.
...
ETLantic 0.38 does not claim a multi-worker or multi-tenant control plane.
