...
> **Status: Available in ETLantic 0.28.0.** This guide describes the bounded,
...
runtime. ETLantic 0.25 does not coordinate a multi-worker runtime.

## Reference topologies

### A. Single process (local / container)

1. Pin `etlantic==0.28.0` and matching plugins in a lockfile.
...
1. Install `etlantic-prefect==0.28.0`.
...
ETLantic 0.25 does not claim a multi-worker or multi-tenant control plane.
