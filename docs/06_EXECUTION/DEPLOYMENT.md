...
> **Status: Available in ETLantic 0.48.0.** This guide describes the bounded,
...
in 0.48.0**. Production **must** split the FastAPI gateway from
...
1. Pin `etlantic==0.48.0` and matching plugins in a lockfile.
...
1. Install `etlantic-prefect==0.48.0`.
