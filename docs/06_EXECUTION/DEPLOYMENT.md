...
> **Status: Available in ETLantic 0.32.0.** This guide describes the bounded,
...
runtime. ETLantic 0.32 does not coordinate a multi-worker runtime.

## Reference topologies

### A. Single process (local / container)

1. Pin `etlantic==0.32.0` and matching plugins in a lockfile.
...
1. Install `etlantic-prefect==0.32.0`.
...
ETLantic 0.32 does not claim a multi-worker or multi-tenant control plane.
