...
> **Status: Available in ETLantic 0.27.0.** This guide describes the bounded,
...
1. Pin `etlantic==0.27.0` and matching plugins in a lockfile.
...
1. Install `etlantic-prefect==0.27.0`.
