...
> are **planned 0.54 optional providers**—they are not shipped, so do not
> configure them yet.
...
| AWS Secrets Manager | Planned 0.54 optional provider |
| Azure Key Vault | Planned 0.54 optional provider |
| Google Cloud Secret Manager | Planned 0.54 optional provider |
| HashiCorp Vault | Planned 0.54 optional provider |
