...
> **Status: Available in ETLantic 0.52.0 (published Beta).** Embed `etlantic-fastapi` in a host
...
```bash
python -m pip install 'etlantic-fastapi==0.52.0'
# or: python -m pip install 'etlantic[fastapi]==0.52.0'
```

Pin the same minor as core (`etlantic==0.52.0`). Package README:
