...
!!! warning "Design study—not a runnable ETLantic 0.30 API guide. Prefer CAPABILITIES and runnable Examples."
    ...
    Prefer [Pipelines](../05_PIPELINES/PIPELINE.md) and runnable guides under [Examples](README.md).
...
This design study explored a multi-output workflow. Treat it as product
