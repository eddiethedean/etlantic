...
!!! warning "Design study—not a runnable ETLantic 0.29 API guide. Prefer CAPABILITIES and runnable Examples."
    ...
    Prefer [Pandas tutorial](../06_EXECUTION/PANDAS_TUTORIAL.md) and `examples/portable_pandas_kernel.py`.
...
This design study explored a pandas pipeline workflow. Treat it as product
