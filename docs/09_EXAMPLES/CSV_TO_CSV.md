...
!!! warning "Design study—not a runnable ETLantic 0.33 API guide. Prefer CAPABILITIES and runnable Examples."
    ...
    Prefer `examples/file_storage.py` and the [File storage tutorial](../06_EXECUTION/FILE_STORAGE_TUTORIAL.md).
...
This design study explored a csv to csv workflow. Treat it as product
