...
!!! warning "Design study—not a runnable ETLantic 0.29 API guide. Prefer CAPABILITIES and runnable Examples."
    ...
    Prefer [PySpark](../06_EXECUTION/PYSPARK_TUTORIAL.md) and [SQL](../06_EXECUTION/SQL_TUTORIAL.md) tutorials.
...
This design study explored a pyspark to sql workflow. Treat it as product
