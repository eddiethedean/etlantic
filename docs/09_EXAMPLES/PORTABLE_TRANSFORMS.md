...
!!! success "**Status: Available since ETLantic 0.17** (Polars + PySpark + Pandas + SQL relational); current docs target **0.25.1**."
...
```bash
pip install 'etlantic==0.25.1' 'etlantic-polars==0.25.1'
# from a checkout:
