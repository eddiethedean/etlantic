...
!!! success "**Status: Available since ETLantic 0.17** (Polars + PySpark + Pandas + SQL relational); current docs target **0.35.0**."
...
```bash
pip install 'etlantic==0.35.0' 'etlantic-polars==0.35.0'
# from a checkout:
