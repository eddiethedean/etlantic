...
!!! warning "Design study—not a runnable ETLantic 0.30 API guide. Prefer CAPABILITIES and runnable Examples."
    ...
    Prefer [Lifecycle Extensions](../06_EXECUTION/LIFECYCLE_EXTENSIONS.md) for shipped callback surfaces.
...
This design study explored a callbacks workflow. Treat it as product
