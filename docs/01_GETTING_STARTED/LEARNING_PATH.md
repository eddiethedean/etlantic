...
> **Status: Available in ETLantic 0.50.1 (published Beta).** One ordered ladder from first
...
| 1 | [Installation](INSTALLATION.md) | `python -m etlantic --version` prints `0.50.1` |
...
- [Current 0.50 Guide](CURRENT_VERSION.md) — task table
