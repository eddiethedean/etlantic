...
> **Status: Available in ETLantic 0.44.0.** One ordered ladder from first
...
| 1 | [Installation](INSTALLATION.md) | `python -m etlantic --version` prints `0.44.0` |
...
- [Current 0.44 Guide](CURRENT_VERSION.md) — task table
