...
> **Status: Available in ETLantic 0.54.0 (Beta release candidate).** One ordered ladder from first
...
| 1 | [Installation](INSTALLATION.md) | `python -m etlantic --version` prints `0.54.0` |
...
- [Current 0.54 Guide](CURRENT_VERSION.md) — task table
