...
> **Status: Available in ETLantic 0.52.0 (published Beta).** One ordered ladder from first
...
| 1 | [Installation](INSTALLATION.md) | `python -m etlantic --version` prints `0.52.0` |
...
- [Current 0.52 Guide](CURRENT_VERSION.md) — task table
