...
> **Status: ETLantic 0.51.0 release candidate; publication pending.** One ordered ladder from first
...
| 1 | [Installation](INSTALLATION.md) | `python -m etlantic --version` prints `0.51.0` |
...
- [Current 0.51 Guide](CURRENT_VERSION.md) — task table
