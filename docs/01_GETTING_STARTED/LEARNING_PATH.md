...
> **Status: Available in ETLantic 0.52.1 (published Beta).** One ordered ladder from first
...
| 1 | [Installation](INSTALLATION.md) | `python -m etlantic --version` prints `0.52.1` |
