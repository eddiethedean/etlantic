...
> **Status: Available in ETLantic 0.33.0.** One ordered ladder from first
...
| Step | Page | Done when |
|---|---|---|
| 1 | [Installation](INSTALLATION.md) | `python -m etlantic --version` prints `0.33.0` |
...
- [Current 0.33 Guide](CURRENT_VERSION.md) — task table
