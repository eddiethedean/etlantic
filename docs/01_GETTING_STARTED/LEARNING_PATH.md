...
> **Status: Available in ETLantic 0.40.0.** One ordered ladder from first
...
| 1 | [Installation](INSTALLATION.md) | `python -m etlantic --version` prints `0.40.0` |
...
- [Current 0.40 Guide](CURRENT_VERSION.md) — task table
