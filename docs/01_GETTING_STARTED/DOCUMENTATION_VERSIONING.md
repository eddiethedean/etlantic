...
2. Activate the git tag `v0.37.0` (build if inactive).
3. Keep **latest** = `main` and **stable** = newest published tag.
4. Confirm `https://etlantic.readthedocs.io/en/v0.37.0/` returns 200.
...
`https://etlantic.readthedocs.io/en/v0.37.0/…` URLs for release-facing readers.
