# Experimental surfaces (0.33)

> **Status: Available in ETLantic 0.33.0 as a map of Experimental APIs.**
...
| FastAPI control plane | `etlantic-fastapi` | Thin authoring/service **reference** adapter — not the 1.1 control plane |
