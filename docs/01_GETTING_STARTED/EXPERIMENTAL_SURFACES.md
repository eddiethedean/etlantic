...
> **Status: Available in ETLantic 0.53.0 (Beta release candidate) as a map of Experimental APIs.**
...
| DataFusion | `etlantic-datafusion` | Provisional portable implementation — 0.50 technical qualification is recorded; independent review remains pending |
...
| Kubernetes / Spark Connect | `etlantic-k8s` / `etlantic-spark-connect` | Experimental fakes; live packs remain 0.57 |
