...
## Is ETLantic 0.29 production-supported?
...
**Available** APIs and behaviors are supported within the documented 0.29
...
reproducible 0.29.0 environment, pin both exactly, for example:
