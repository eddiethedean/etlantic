...
Practical questions for ETLantic **0.40.0**. Philosophy and contract taxonomy
...
```bash
python -m pip install 'etlantic==0.40.0' 'etlantic-polars==0.40.0'
```
...
## Is ETLantic 0.40 production-supported?
