...
Practical questions for ETLantic **0.52.1**. Philosophy and contract taxonomy
...
```bash
python -m pip install 'etlantic==0.52.1' 'etlantic-polars==0.52.1'
```
...
## Is ETLantic 0.52 production-supported?

ETLantic **0.52.1** is **Beta**, community-supported, with no SLA. Use it for
...
**Available** means it is in the 0.52 product envelope: documented, tested, and
...
payloads or secrets. Adaptive planning and physical-DAG execution are not yet
available. See [What's new in 0.52](WHATS_NEW_0_51.md).
