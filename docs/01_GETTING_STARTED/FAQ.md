...
**Available** APIs and behaviors are supported within the documented 0.33
...
reproducible 0.33.0 environment, pin both exactly, for example:
...
[Migration 0.31 → 0.33](../11_DEVELOPMENT/MIGRATION_0_31_TO_0_32.md).
