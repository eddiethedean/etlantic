...
## Is ETLantic 0.32 production-supported?
...
**Available** APIs and behaviors are supported within the documented 0.32
...
reproducible 0.32.0 environment, pin both exactly, for example:

```bash
python -m pip install 'etlantic==0.32.0' 'etlantic-polars==0.32.0'
```
