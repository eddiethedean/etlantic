...
Practical questions for ETLantic **0.39.0**. Philosophy and contract taxonomy
...
```bash
python -m pip install 'etlantic==0.39.0' 'etlantic-polars==0.39.0'
```
...
## Is ETLantic 0.39 production-supported?
