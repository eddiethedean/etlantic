...
Practical questions for ETLantic **0.45.0**. Philosophy and contract taxonomy
...
## Is ETLantic 0.45 production-supported?

ETLantic **0.45.0** is a **Beta** (PyPI) release for documented single-tenant
