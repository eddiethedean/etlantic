...
Practical questions for ETLantic **0.53.0**. Philosophy and contract taxonomy
...
ETLantic **0.53.0** is **Beta**, community-supported, with no SLA. Use it for
...
payloads or secrets. Adaptive execution remains Experimental and restricted
to fixture-qualified local static-batch plans; durable and remote adaptive
execution are unavailable. See [What's new in 0.53](WHATS_NEW_0_53.md).
