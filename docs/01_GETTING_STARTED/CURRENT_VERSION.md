...
ETLantic **0.42.0** is a **Beta** (PyPI) release for documented single-tenant
pilots plus CP4 multi-tenant **release-candidate** incubation. **CP4 is not
production multi-tenant isolation** (**0.43**). Linked reference and design
...
3. [What's new in 0.42](WHATS_NEW_0_42.md)
...
| Embed control-plane HTTP API | [What's new in 0.42](WHATS_NEW_0_42.md) / `pip install etlantic-fastapi` |
...
| Optional OpenLineage outbound | `pip install 'etlantic[openlineage]==0.42.0'` (Experimental) |
