...
3. [What's new in 0.44](WHATS_NEW_0_43.md)
...
| Goal | Guide |
|---|---|
| Adopt CP-GA multi-tenant | [What's new in 0.44](WHATS_NEW_0_43.md) / [Migration 0.42 → 0.43](../11_DEVELOPMENT/MIGRATION_0_42_TO_0_43.md) / [CP-GA runbook](../11_DEVELOPMENT/CP_GA_OPERATOR_RUNBOOK_0_43.md) |
...
| Embed control-plane HTTP API | [What's new in 0.44](WHATS_NEW_0_43.md) / `pip install etlantic-fastapi` |
