...
> **Status: Available in ETLantic 0.40.0.** Reproducible checklist for a
...
| Component | Pin |
|---|---|
| Core | `etlantic==0.40.0` |
| Docs | `https://etlantic.readthedocs.io/en/v0.40.0/` |
| Optional engines | Matching `0.40.0` plugins (`etlantic-polars`, `etlantic-sql`, …) |
| Facade | `medallantic==0.40.0` when used |
...
Companion: [`examples/sample_pilot/`](https://github.com/eddiethedean/etlantic/tree/v0.40.0/examples/sample_pilot).
