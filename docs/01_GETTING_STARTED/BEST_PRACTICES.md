...
> **Status: ETLantic 0.51.0 release candidate; publication pending.** Adopter-facing habits for safe,
...
4. Pin matching minors: `etlantic==0.51.0` with `etlantic-polars==0.51.0`, etc.
