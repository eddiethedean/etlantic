...
> **Status: Available in ETLantic 0.52.0 (published Beta).** Adopter-facing habits for safe,
...
4. Pin matching minors: `etlantic==0.52.0` with `etlantic-polars==0.52.0`, etc.
