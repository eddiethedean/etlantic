...
> **Project status:** Alpha **0.13.0**. See [Capabilities](CAPABILITIES.md)
...
1. [Current 0.13 guide](CURRENT_VERSION.md) — task-based map
2. [Installation](INSTALLATION.md) — `pip install etlantic==0.13.0`
...
ETLantic 0.13.0 can execute registered Python implementations with its local
