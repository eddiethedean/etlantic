...
> **Project status:** ETLantic **0.28.0** is a **Beta** (PyPI) release suitable within the documented
...
(Support), [What's New in 0.28](WHATS_NEW_0_28.md).
...
ETLantic 0.28.0 can execute registered Python implementations with its local
