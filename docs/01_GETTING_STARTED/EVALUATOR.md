...
| LTS | Current published minor only (`0.28.x`) |
...
## What is ready in bounded 0.28.0
...
- Report vulnerabilities privately; security fixes are supported on 0.28.x
...
ETLantic **0.28.0** is a **Beta** (PyPI) release suitable for documented
...
| Supported versions / EOL | Current Beta line is 0.28.x; see [SECURITY.md](https://github.com/eddiethedean/etlantic/blob/main/SECURITY.md) |
