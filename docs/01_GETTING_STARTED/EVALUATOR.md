...
| LTS | Current published minor only (`0.50.x`) |
...
## What is ready in bounded 0.50.0
...
| Concern | Status in 0.50 |
|---|---|
| License | MIT (core and official plugins) |
| Supported versions / EOL | Current Beta line is 0.50.x; see [SECURITY.md](https://github.com/eddiethedean/etlantic/blob/main/SECURITY.md) |
...
6. Optional Gate A: checkout
   ...
   with `etlantic-polars` + `etlantic-pandas` at `==0.50.0`
