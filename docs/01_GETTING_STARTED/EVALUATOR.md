...
| LTS | Current published minor only (`0.29.x`) |
...
## What is ready in bounded 0.29.0
...
- Report vulnerabilities privately; security fixes are supported on 0.29.x
...
ETLantic **0.29.0** is a **Beta** (PyPI) release suitable for documented
