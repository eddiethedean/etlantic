...
| LTS | Current published minor only (`0.27.x`) |
...
## What is ready in bounded 0.27.0
...
- Report vulnerabilities privately; security fixes are supported on 0.27.x
...
ETLantic **0.27.0** is a **Beta** (PyPI) release suitable for documented
...
| Concern | Status in 0.27 |
|---|---|
| License | MIT (core and official plugins) |
| Supported versions / EOL | Current Beta line is 0.27.x; see [SECURITY.md](https://github.com/eddiethedean/etlantic/blob/main/SECURITY.md) |
...
1. [Installation](INSTALLATION.md) — `pip install etlantic==0.27.0`
...
6. Optional Gate A: checkout
   ...
   with `etlantic-polars` + `etlantic-pandas` at `==0.27.0`
