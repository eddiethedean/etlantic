...
| LTS | Current release-candidate minor only (`0.52.x`) |
...
| Concern | Status in 0.52 |
|---|---|
| License | MIT (core and official plugins) |
| Supported versions / EOL | Current Beta line is 0.52.x; see [SECURITY.md](https://github.com/eddiethedean/etlantic/blob/main/SECURITY.md) |
