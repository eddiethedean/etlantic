...
> **Status: Available in ETLantic 0.50.1 (published Beta).** What is implemented and technically
...
ETLantic 0.50.1 is a **published Beta** for documented, controlled,
...
| Adaptive heterogeneous planning and executable physical DAGs | **Contract accepted; not currently available** for 0.51: opt-in static-batch local execution with bounded `/2` plans remains evidence-gated. Proposed qualification is Local/Polars/Pandas single-target plus directional Polars↔Pandas Gate A — see [ADR-025](../11_DEVELOPMENT/adr/ADR-025-ADAPTIVE-EXECUTION-AND-PHYSICAL-DAG.md), [implementation plan](../11_DEVELOPMENT/IMPLEMENTATION_PLAN_0_51.md), [exit gate](../11_DEVELOPMENT/EXIT_GATE_0_51.md), and [epic #30](https://github.com/eddiethedean/etlantic/issues/30) |
