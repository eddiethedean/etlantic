...
> **Status: Available in ETLantic 0.53.0 (Beta release candidate).** What is implemented and technically
...
## What works today (0.53)

ETLantic 0.53.0 is the **Beta release candidate** for documented, controlled,
single-tenant pilots (install `etlantic==0.53.0` from PyPI). You can embed an
...
(the sample uses Polars — install `etlantic-polars==0.53.0` first).
...
pip install 'etlantic[lsp]==0.53.0'            # optional language server
pip install 'etlantic-polars==0.53.0'          # optional
pip install 'etlantic-pandas==0.53.0'          # optional
pip install 'etlantic-sql==0.53.0'             # optional
pip install 'etlantic-pyspark==0.53.0'         # optional
pip install 'etlantic-airflow==0.53.0'         # optional
pip install 'etlantic-prefect==0.53.0'         # optional
pip install 'etlantic-keyring==0.53.0'         # optional
pip install 'etlantic-sqlmodel==0.53.0'        # optional
pip install 'medallantic==0.53.0'              # optional
```
