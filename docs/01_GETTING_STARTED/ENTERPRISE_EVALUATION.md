...
> **Status: Available in ETLantic 0.41.0.** Deep diligence packet. Start with the
...
After the v0.41.0 tag workflow succeeds, expect a per-artifact SHA-256
...
[Release artifact verification](RELEASE_ARTIFACT_VERIFICATION.md).
Prefer exact pins (`etlantic==0.41.0` and matching plugins) over floating
...
- Practitioners: continue the [Current 0.41 Guide](CURRENT_VERSION.md)
