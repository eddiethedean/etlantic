...
| Artifact | Location |
|---|---|
| Version pins | Pin `etlantic==0.48.0` and matching plugin minors |
...
For a published GitHub Release asset (example: wheel from the `v0.48.0` release):
...
[v0.48.0 GitHub Release](https://github.com/eddiethedean/etlantic/releases/tag/v0.48.0).
...
[Release artifact verification](RELEASE_ARTIFACT_VERIFICATION.md).
Prefer exact pins (`etlantic==0.48.0` and matching plugins) over floating
...
- Practitioners: continue the [Current 0.48 Guide](CURRENT_VERSION.md)
