...
| **Dagster** | Orchestration and software-defined assets | Complementary — compiler bridge planned for 0.56, not shipped |
...
- Broader compliance programs and multi-tenant attestation (adopters own these;
  ...
  Supported isolation profiles are Available via the control plane — see
...
| You need unrestricted shared-service multi-tenant SaaS or a formal SLA today | Wait / supplement — Supported profiles Available; community **non-SLA**; Operator Console is 0.57 |
