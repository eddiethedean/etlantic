...
> **Status: Available in ETLantic 0.52.0 (published Beta) (Gate A).** Public versioned tabular
...
```bash
pip install 'etlantic==0.52.0' 'etlantic-polars==0.52.0' 'etlantic-pandas==0.52.0'
# from a checkout:
