...
> **Status: Available in ETLantic 0.54.0 (Beta release candidate) (Gate A).** Public versioned tabular
...
```bash
pip install 'etlantic==0.54.0' 'etlantic-polars==0.54.0' 'etlantic-pandas==0.54.0'
# from a checkout:
