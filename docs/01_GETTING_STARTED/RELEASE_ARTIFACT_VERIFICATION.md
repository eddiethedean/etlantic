...
## Release artifact contract for v0.36.0

| Artifact | Status |
|---|---|
| PyPI wheels/sdists for core and official packages | Expected after the tag workflow succeeds (`etlantic==0.36.0`, matching plugins) |
| Per-artifact SHA-256 manifest | Expected as [release-artifacts.json](https://github.com/eddiethedean/etlantic/releases/download/v0.36.0/release-artifacts.json) |
...
1. After publication, download the wheel (or sdist) and
   `release-artifacts.json` from the
