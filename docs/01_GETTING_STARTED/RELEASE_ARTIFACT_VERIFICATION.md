...
| Artifact | Status |
|---|---|
| PyPI wheels/sdists for core and official packages | Expected after tag; verify `etlantic==0.52.0` and matching plugins |
| Per-artifact SHA-256 manifest | [release-artifacts.json](https://github.com/eddiethedean/etlantic/releases/download/v0.52.0/release-artifacts.json) |
