...
!!! danger "Historical snapshot—not the current [DTCS](../04_TRANSFORMATIONS/DTCS.md) specification"
    DTCS 3.0.0 and the `dtcs` 0.14.0 toolkit are published. The canonical
