...
!!! tip "Green path (start here only)"
    1. [Installation](01_GETTING_STARTED/INSTALLATION.md) — `pip install etlantic==0.31.0`
...
**ETLantic 0.31.0** is a **Beta** release for documented single-tenant pilots.
Install with `pip install 'etlantic==0.31.0'`.
