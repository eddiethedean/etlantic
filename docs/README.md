...
<div class="etlantic-hero">
  <div class="etlantic-hero__content">
    <span class="etlantic-hero__eyebrow">ETLantic 0.49 · Beta</span>
...
`etlantic==0.49.0` so this version of the documentation and the installed API
...
|---|---|---|
| Local Python + JSON/CSV | `pip install 'etlantic==0.49.0'` | Built-in first-success and test path |
| Polars | `pip install 'etlantic[polars]==0.49.0'` | Eager/lazy execution and portable compilation |
| Pandas | `pip install 'etlantic[pandas]==0.49.0'` | Eager execution and portable compilation |
| SQL | `pip install 'etlantic[sql]==0.49.0'` | SQLite evaluation and PostgreSQL reference execution |
| PySpark | `pip install 'etlantic[pyspark]==0.49.0'` | Batch Spark execution; compatible JVM required |
| Airflow | `pip install 'etlantic[airflow]==0.49.0'` | DAG compilation; Apache Airflow installs separately |
| Prefect | `pip install 'etlantic[prefect]==0.49.0'` | Bounded local direct-execution integration |
...
| Review the current release | [What's new in 0.49](01_GETTING_STARTED/WHATS_NEW_0_49.md) |
