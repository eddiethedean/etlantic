...
> **Status: ETLantic 0.51.0 release candidate; publication pending.** Async `/1` protocol with entry-point
...
are assigned to the 0.40 metadata-interoperability gate in the
