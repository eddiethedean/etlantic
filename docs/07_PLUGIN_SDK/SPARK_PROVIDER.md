...
in-process fake is Available in **0.50.0**. Live Databricks, EMR, and Spark
Connect packs remain deferred (`047-S-01` / 0.54). See the
...
live isolated clusters are 0.54. Do not implement against this section yet.
