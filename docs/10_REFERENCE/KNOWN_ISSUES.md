...
| DOC-008 | Spark providers | Cloud Spark | 0.48 ships Kubernetes and Spark Connect Experimental fakes, not live managed providers | Run local `etlantic-pyspark` or your own provider; live packs remain planned for 0.52 | Open |
