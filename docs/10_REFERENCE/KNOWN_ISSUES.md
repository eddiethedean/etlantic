...
| DOC-008 | Spark providers | Cloud Spark | Managed Databricks / EMR / Connect not in 0.36 | Run local `etlantic-pyspark` or own provider; reference proof planned 0.48 / packs 0.52 | Open |
