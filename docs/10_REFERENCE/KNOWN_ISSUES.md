...
|---|---|---|---|---|---|
| DOC-001 | Release maturity | All adopters | Breaking API changes possible between 0.x minors | Pin `etlantic==0.54.0` and matching plugins; follow Upgrade hub | Open (Beta) |
