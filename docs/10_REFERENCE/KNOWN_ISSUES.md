...
ETLantic **0.34.x** is a **Beta** (PyPI) release suitable for documented
...
|---|---|---|---|---|---|
| DOC-001 | Release maturity | All adopters | Breaking API changes possible between 0.x minors | Pin `etlantic==0.34.0` and matching plugins; follow Upgrade hub | Open (Beta) |
...
| DOC-008 | Spark providers | Cloud Spark | Managed Databricks / EMR / Connect not in 0.34 | Run local `etlantic-pyspark` or own provider; reference proof planned 0.48 / packs 0.52 | Open |
