...
ETLantic **0.52.x** is a **Beta** release suitable for documented
...
|---|---|---|---|---|---|
| DOC-001 | Release maturity | All adopters | Breaking API changes possible between 0.x minors | Pin `etlantic==0.52.0` and matching plugins; follow Upgrade hub | Open (Beta) |
...
| DOC-008 | Spark providers | Cloud Spark | 0.49 ships Kubernetes and Spark Connect Experimental fakes, not live managed providers | Run local `etlantic-pyspark` or your own provider; live packs remain planned for 0.57 | Open |
