...
> **Status: Available in ETLantic 0.49.0.** Core `etlantic` does not install
...
pip install 'etlantic-polars==0.49.0'
pip install 'etlantic-pandas==0.49.0'
pip install 'etlantic-sql==0.49.0'
pip install 'etlantic-pyspark==0.49.0'
pip install 'etlantic-airflow==0.49.0'
pip install 'etlantic-prefect==0.49.0'
pip install 'etlantic-keyring==0.49.0'
pip install 'etlantic-sqlmodel==0.49.0'
pip install 'medallantic==0.49.0'
# optional compatibility redirect (deprecated):
pip install 'etlantic-sparkforge==0.49.0'
# experimental connectors (fake/CI; Alpha — not Supported):
pip install 'etlantic-s3==0.49.0'
pip install 'etlantic-iceberg==0.49.0'
pip install 'etlantic-snowflake==0.49.0'
pip install 'etlantic-k8s==0.49.0'
pip install 'etlantic-spark-connect==0.49.0'
pip install 'etlantic-mcp==0.49.0'
```

Official first-party plugins declare `etlantic>=0.49.0,<0.50`.
...
`etlantic-datafusion==0.49.0` — provisional portable dataframe/compiler implementation (0.50 technical qualification recorded; independent review pending).
