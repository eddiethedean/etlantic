...
> **Status: Available in ETLantic 0.25.1.** Core `etlantic` does not install
...
```bash
pip install 'etlantic==0.25.1'
pip install 'etlantic-polars==0.25.1'
pip install 'etlantic-pandas==0.25.1'
pip install 'etlantic-sql==0.25.1'
pip install 'etlantic-pyspark==0.25.1'
pip install 'etlantic-airflow==0.25.1'
pip install 'etlantic-prefect==0.25.1'
pip install 'etlantic-keyring==0.25.1'
pip install 'etlantic-sqlmodel==0.25.1'
pip install 'etlantic-sparkforge==0.25.1'
```
...
Experimental (not recommended): `pip install 'etlantic[datafusion]==0.25.1'`
or `etlantic-datafusion==0.25.1` — Gate B stub; no graduated claims.

Optional reference adapter: `pip install 'etlantic-fastapi==0.25.1'` or
`etlantic[fastapi]==0.25.1` — thin authoring/service HTTP adapter (shipped since
0.24; not
...
| [`etlantic-fastapi`](https://github.com/eddiethedean/etlantic/blob/main/packages/etlantic-fastapi/README.md) | `etlantic_fastapi` | Thin FastAPI authoring/service reference adapter (shipped since 0.24; pin `==0.25.1`) |
