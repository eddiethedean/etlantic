...
> **Status: ETLantic 0.50.0 release candidate; publication pending.** Core `etlantic` does not install
...
pip install 'etlantic-polars==0.50.0'
pip install 'etlantic-pandas==0.50.0'
pip install 'etlantic-sql==0.50.0'
pip install 'etlantic-pyspark==0.50.0'
pip install 'etlantic-airflow==0.50.0'
pip install 'etlantic-prefect==0.50.0'
...
pip install 'etlantic-sparkforge==0.50.0'
...
DataFusion: `pip install 'etlantic[datafusion]==0.50.0'` or
`etlantic-datafusion==0.50.0` — provisional portable dataframe/compiler implementation (0.50 technical qualification recorded; independent review pending).

Optional FastAPI package: `pip install 'etlantic-fastapi==0.50.0'` or
`etlantic[fastapi]==0.50.0` — **dual surface**: CP1 (`ETLanticAPI` /
...
| [`etlantic-fastapi`](https://github.com/eddiethedean/etlantic/blob/main/packages/etlantic-fastapi/README.md) | `etlantic_fastapi` | Dual surface: CP1 `ETLanticAPI` + thin `create_reference_app` (pin `==0.50.0`; CPn alone ≠ GA) |
| [`etlantic-lsp`](https://github.com/eddiethedean/etlantic/blob/main/packages/etlantic-lsp/README.md) | `etlantic_lsp` | Editor-neutral language server (`etlantic[lsp]` / pin `==0.50.0`) |
