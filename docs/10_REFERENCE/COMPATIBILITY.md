...
This table describes the declared compatibility of ETLantic 0.25.0.
...
| Polars plugin | `etlantic-polars==0.25.0` |
| Pandas plugin | `etlantic-pandas==0.25.0` |
| SQL plugin | `etlantic-sql==0.25.0` |
| PySpark plugin | `etlantic-pyspark==0.25.0` |
| Airflow plugin | `etlantic-airflow==0.25.0` |
| Prefect scheduler | `etlantic-prefect==0.25.0` |
| Keyring provider | `etlantic-keyring==0.25.0` |
| SQLModel bridge | `etlantic-sqlmodel==0.25.0` |
| SparkForge adapter | `etlantic-sparkforge==0.25.0` |
| DataFusion plugin | `etlantic-datafusion==0.25.0` (**Experimental** Gate B stub; no graduated claims) |
...
`etlantic==0.25.0` plus every official plugin to `==0.25.0`.

Core extras already enforce exact official plugin versions, for example
`etlantic[polars]==0.25.0` depends on `etlantic-polars==0.25.0`. Official
