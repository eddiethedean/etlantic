...
PMSVCxxx   Scheduler-service topology / memory-store reject (0.47)
...
PMCTXxxx   Context-bundle budget / provenance / redaction (0.49, experimental)
PMPROPxxx  Proposal sandbox / untrusted input (0.49, experimental)
PMGUIDExxx Generator user-region conflicts (0.49, experimental)
PMMCPxxx   MCP method authority / allowlist (0.49, experimental)
...
These codes are emitted by the installed ETLantic package (currently **0.51.0** /
0.47.x).
...
(code → source paths). **Family stability tiers:**
[Diagnostic-code stability tiers](DIAGNOSTIC_STABILITY_TIERS.md). Regenerate with:
