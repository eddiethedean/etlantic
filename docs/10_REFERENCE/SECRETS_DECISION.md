...
> **Status: ETLantic 0.51.0 release candidate; publication pending.** Normative rules for `SecretRef`
...
cloud identity providers are planned as optional 0.54 provider packs. They are
