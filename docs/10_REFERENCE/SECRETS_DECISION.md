...
> **Status: Available in ETLantic 0.51.0 (published Beta).** Normative rules for `SecretRef`
...
cloud identity providers are planned as optional 0.57 provider packs. They are
