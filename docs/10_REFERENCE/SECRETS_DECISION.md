# Secrets decision tree (0.33)

> **Status: Available in ETLantic 0.34.0.** Normative rules for `SecretRef`
...
AWS Secrets Manager, Vault, and cloud identity providers remain **future
design**. Do not configure them yet.
