...
> **Status: ETLantic 0.50.0 release candidate; publication pending.** Signatures and docstrings are
...
ETLantic 0.43.0 is a **Beta** (PyPI) release suitable for documented single-tenant reference
