...
ETLantic 0.52.1 configures execution with a `Profile` object, a JSON profile
...
ETLantic 0.52.1 does not auto-read `ETLANTIC_PROFILE`, `ETLANTIC_CONFIG`,
