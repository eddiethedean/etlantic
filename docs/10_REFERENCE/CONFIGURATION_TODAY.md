# Configuration in 0.53

> **Status: Available in ETLantic 0.53.0 (Beta release candidate).**

ETLantic 0.53.0 configures execution with a `Profile` object, a JSON profile
...
ETLantic 0.53.0 does not auto-read `ETLANTIC_PROFILE`, `ETLANTIC_CONFIG`,
