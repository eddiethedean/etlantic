# Configuration in 0.52

> **Status: Available in ETLantic 0.52.0 (published Beta).**

ETLantic 0.52.0 configures execution with a `Profile` object, a JSON profile
...
ETLantic 0.52.0 does not auto-read `ETLANTIC_PROFILE`, `ETLANTIC_CONFIG`,
