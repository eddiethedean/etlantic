# Configuration in 0.32.0

ETLantic 0.32.0 configures execution with a `Profile` object, a JSON profile
...
ETLantic 0.32.0 does not auto-read `ETLANTIC_PROFILE`, `ETLANTIC_CONFIG`,
