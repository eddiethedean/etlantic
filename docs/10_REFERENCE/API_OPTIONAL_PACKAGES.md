...
> **Status: Available in ETLantic 0.53.0 (Beta release candidate).** Per-package API pages for first-party
...
- [etlantic-mcp](api_optional/etlantic_mcp.md) — Experimental read-only MCP extra (fake/CI)
