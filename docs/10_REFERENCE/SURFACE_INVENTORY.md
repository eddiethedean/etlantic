...
> **Status: Available in ETLantic 0.54.0 (Beta release candidate).** Canonical public surface for the
> **0.54 reference envelope**.
...
| Class | Meaning |
|---|---|
| `stable` | Supported within the documented 0.54 reference envelope |
...
| `etlantic.remote-runtime/1` | stable (0.47; in-process fake host) |
| `etlantic.resource/1` | experimental (0.47; `etlantic-k8s` Extra) |
...
Pin to the same minor as core (`==0.54.0`). Details:
