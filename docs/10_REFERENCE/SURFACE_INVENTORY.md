...
> **Status: Available in ETLantic 0.53.0 (Beta release candidate).** Canonical public surface for the
> **0.53 reference envelope**.
...
| Class | Meaning |
|---|---|
| `stable` | Supported within the documented 0.53 reference envelope |
...
Pin to the same minor as core (`==0.53.0`). Details:
