...
> **Status: Available in ETLantic 0.52.0 (published Beta).** Canonical public surface for the
> **0.52 reference envelope**.
...
| Class | Meaning |
|---|---|
| `stable` | Supported within the documented 0.52 reference envelope |
...
Pin to the same minor as core (`==0.52.0`). Details:
