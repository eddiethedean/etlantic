...
> **Status: Available in ETLantic 0.31.0.** Canonical public surface for the
...
| Class | Meaning |
|---|---|
| `stable` | Supported within the documented 0.31 reference envelope |
...
Pin to the same minor as core (`==0.31.0`). Details:
