...
> **Status: Available in ETLantic 0.42.0.** Canonical public surface for the
> **0.42 reference envelope**.
...
| Class | Meaning |
|---|---|
| `stable` | Supported within the documented 0.42 reference envelope |
...
Pin to the same minor as core (`==0.42.0`). Details:
