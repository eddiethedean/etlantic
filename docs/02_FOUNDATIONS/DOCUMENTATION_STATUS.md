...
Prefer pages marked **Available in 0.38** and the Green path on the docs
...
[Exit gate 0.37](../11_DEVELOPMENT/EXIT_GATE_0_37.md) and
[Migration 0.36 → 0.37](../11_DEVELOPMENT/MIGRATION_0_36_TO_0_37.md). Latest
...
2. Treat **Available in 0.38** / **Shipped in 0.x** as current package
...
| Page status | Meaning |
|---|---|
| Available in 0.38 | Tested against the current package |
