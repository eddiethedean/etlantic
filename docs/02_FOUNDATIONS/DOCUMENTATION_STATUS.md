...
Prefer pages marked **Available in 0.49** and the Green path on the docs
...
2. Treat **Available in 0.49** / **Shipped in 0.x** as current package
...
| Page status | Meaning |
|---|---|
| Available in 0.49 | Tested against the current package |
