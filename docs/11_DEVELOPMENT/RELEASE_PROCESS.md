...
Official plugins declare `etlantic>=0.51.0,<0.52`.
...
| Provisional | `etlantic-datafusion` | Alpha | 0.50 technical qualification recorded and retained |
...
**0.51** plugins, `etlantic>=0.51.0,<0.52`). A core
