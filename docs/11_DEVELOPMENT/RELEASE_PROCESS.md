...
plugin packages currently share the core minor version (for example `0.31.0`).
Official plugins declare `etlantic>=0.31.0,<0.32`.
...
0.25 plugins, `etlantic>=0.31.0,<0.32`). A core
