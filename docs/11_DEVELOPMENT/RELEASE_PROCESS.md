...
plugin packages currently share the core minor version (for example `0.32.0`).
Official plugins declare `etlantic>=0.32.0,<0.33`.
...
0.25 plugins, `etlantic>=0.32.0,<0.33`). A core
