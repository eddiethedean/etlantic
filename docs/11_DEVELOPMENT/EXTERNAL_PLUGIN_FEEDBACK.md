...
> **0.39.0**; expected echo package floor is `etlantic>=0.42,<0.43` (workflow
...
| Date | 2026-07-30 (freeze evidence in 0.28; revalidated on 0.39.0; expected pin `etlantic>=0.42,<0.43`) |
