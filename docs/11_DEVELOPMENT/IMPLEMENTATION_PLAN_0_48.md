...
- Brownfield dbt/orchestrator import is 0.55. Operator console is 0.56. Live
  cloud providers are 0.57.
...
| GitOps promotion / 0.55–0.57 programs | **Out of 0.48** | Existing or later phases |
...
## 0.55 / 0.56 / 0.57 boundary

[IMPLEMENTATION_PLAN_0_55](IMPLEMENTATION_PLAN_0_55.md) owns brownfield
metadata import and orchestration compilers.
[IMPLEMENTATION_PLAN_0_56](IMPLEMENTATION_PLAN_0_56.md) owns the operator
console. [IMPLEMENTATION_PLAN_0_57](IMPLEMENTATION_PLAN_0_57.md) owns live
