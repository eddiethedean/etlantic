...
- Brownfield dbt/orchestrator import is 0.52. Operator console is 0.53. Live
  cloud providers are 0.54.
...
| GitOps promotion / 0.52–0.54 programs | **Out of 0.48** | Existing or later phases |
...
## 0.52 / 0.53 / 0.54 boundary

[IMPLEMENTATION_PLAN_0_52](IMPLEMENTATION_PLAN_0_52.md) owns brownfield
metadata import and orchestration compilers.
[IMPLEMENTATION_PLAN_0_53](IMPLEMENTATION_PLAN_0_53.md) owns the operator
console. [IMPLEMENTATION_PLAN_0_54](IMPLEMENTATION_PLAN_0_54.md) owns live
