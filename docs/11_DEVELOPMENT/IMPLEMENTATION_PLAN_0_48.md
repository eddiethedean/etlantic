...
- Brownfield dbt/orchestrator import is 0.56. Operator console is 0.57. Live
  cloud providers are 0.58.
...
| GitOps promotion / 0.56–0.58 programs | **Out of 0.48** | Existing or later phases |
...
## 0.56 / 0.57 / 0.58 boundary

[IMPLEMENTATION_PLAN_0_56](IMPLEMENTATION_PLAN_0_56.md) owns brownfield
metadata import and orchestration compilers.
[IMPLEMENTATION_PLAN_0_57](IMPLEMENTATION_PLAN_0_57.md) owns the operator
console. [IMPLEMENTATION_PLAN_0_58](IMPLEMENTATION_PLAN_0_58.md) owns live
