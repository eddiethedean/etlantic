...
- [Exit gate 0.47](EXIT_GATE_0_47.md) (Gate-ready)
...
- [Migration 0.42 → 0.43](MIGRATION_0_42_TO_0_43.md) (Released — CP-GA)
- [Exit gate 0.43](EXIT_GATE_0_43.md) (Released — CP-GA)
- [Findings ledger 0.43](FINDINGS_0_43.md)
- [0.43 implementation plan](IMPLEMENTATION_PLAN_0_43.md)
- [What's new in 0.43](../01_GETTING_STARTED/WHATS_NEW_0_43.md) (Released)
...
- [Forward implementation plans](FORWARD_IMPLEMENTATION_PLANS.md) (0.39–0.59 delivery contract)
...
Current release: [What's new in 0.54](../01_GETTING_STARTED/WHATS_NEW_0_54.md),
