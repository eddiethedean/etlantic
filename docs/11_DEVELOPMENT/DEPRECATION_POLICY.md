...
ETLantic 0.30.0 is a Beta (PyPI) release suitable for documented single-tenant pilots—not unrestricted enterprise production,
...
|---|---|
| Documented 0.30 public imports | Supported for the 0.30.x line |
