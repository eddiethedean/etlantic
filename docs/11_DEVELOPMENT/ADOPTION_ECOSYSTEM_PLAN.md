...
> 0.37.0.** This plan assigns the adoption capabilities that were previously
...
| 0.47 | Kubernetes and managed execution **Experimental fakes** (`etlantic-k8s`, `etlantic-spark-connect`) plus conforming remote-runtime protocol | Remote execution profiles (fakes); live packs remain 0.54 |
| 0.52 | Brownfield adoption bridges | Supported import/compiler compatibility matrix |
| 0.53 | Operator console | Supported control-plane operations UI |
| 0.54 | Enterprise provider packs | Supported cloud provider matrix |
| 0.55 | TransformationModel incubation | Independently useful modeling package |
...
- [0.52 brownfield bridges](IMPLEMENTATION_PLAN_0_52.md)
- [0.53 operator console](IMPLEMENTATION_PLAN_0_53.md)
- [0.54 managed-runtime and provider packs](IMPLEMENTATION_PLAN_0_54.md)
- [0.55 TransformationModel incubation](IMPLEMENTATION_PLAN_0_55.md)
...
- [TransformationModel Incubation Plan](TRANSFORMATIONMODEL_PLAN.md) owns the
  0.55 package boundary and graduation.
...
| Select supported dbt artifact and orchestrator versions | Migration + orchestration maintainers | Before 0.52 preview |
| Select operator-console frontend architecture and support matrix | API + UI maintainers | Before 0.53 implementation |
| Select supported cloud regions, identity modes, and live-test accounts | Provider + security maintainers | Before 0.54 preview |
