...
| 0.47 | Kubernetes and managed execution **Experimental fakes** (`etlantic-k8s`, `etlantic-spark-connect`) plus conforming remote-runtime protocol | Remote execution profiles (fakes); live packs remain 0.57 |
| 0.55 | Brownfield adoption bridges | Supported import/compiler compatibility matrix |
| 0.56 | Operator console | Supported control-plane operations UI |
| 0.57 | Enterprise provider packs | Supported cloud provider matrix |
| 0.58 | TransformationModel incubation | Independently useful modeling package |
...
- [0.55 brownfield bridges](IMPLEMENTATION_PLAN_0_55.md)
- [0.56 operator console](IMPLEMENTATION_PLAN_0_56.md)
- [0.57 managed-runtime and provider packs](IMPLEMENTATION_PLAN_0_57.md)
- [0.58 TransformationModel incubation](IMPLEMENTATION_PLAN_0_58.md)
...
- [TransformationModel Incubation Plan](TRANSFORMATIONMODEL_PLAN.md) owns the
  0.58 package boundary and graduation.
...
| Select supported dbt artifact and orchestrator versions | Migration + orchestration maintainers | Before 0.55 preview |
| Select operator-console frontend architecture and support matrix | API + UI maintainers | Before 0.56 implementation |
| Select supported cloud regions, identity modes, and live-test accounts | Provider + security maintainers | Before 0.57 preview |
