...
| 0.43 | First-class multi-tenant graduation (CP-GA) | [0.43](IMPLEMENTATION_PLAN_0_43.md) | [Multi-tenant control plane](MULTI_TENANT_CONTROL_PLANE_PLAN.md) |
...
| 0.51 | Opt-in static-batch adaptive placement and authoritative `/2` physical DAGs on qualified local runtimes | [0.51](IMPLEMENTATION_PLAN_0_51.md) ([epic #30](https://github.com/eddiethedean/etlantic/issues/30)) | [Developer roadmap](https://github.com/eddiethedean/etlantic/blob/main/ROADMAP.md) |
