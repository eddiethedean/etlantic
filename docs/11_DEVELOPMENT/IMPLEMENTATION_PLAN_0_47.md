...
- Kubernetes and Spark Connect are Experimental reference extras, not core
  dependencies. Live Kind/cluster and live Databricks/EMR are 0.54 (or
...
| `etlantic-spark-connect` + fake | **Experimental** | Live Databricks/EMR = 0.54; skip `047-S-01` |
...
- Kubernetes and Spark Connect Experimental extras pass fake conformance;
  live isolated deployments remain skip `047-K-01` / `047-S-01` until 0.54.
...
in-process fakes. Do not pull 0.54 live-cluster production claims into this
gate.
