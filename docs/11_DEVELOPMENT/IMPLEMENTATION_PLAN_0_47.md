...
- Kubernetes and Spark Connect are Experimental reference extras, not core
  dependencies. Live Kind/cluster and live Databricks/EMR are 0.57 (or
...
| `etlantic-spark-connect` + fake | **Experimental** | Live Databricks/EMR = 0.57; skip `047-S-01` |
| Helm/OCI production images | **Out of 0.47** | 0.57 `057-D` |
...
- Kubernetes and Spark Connect Experimental extras pass fake conformance;
  live isolated deployments remain skip `047-K-01` / `047-S-01` until 0.57.
...
[IMPLEMENTATION_PLAN_0_57](IMPLEMENTATION_PLAN_0_57.md) hardens live Kubernetes
...
in-process fakes. Do not pull 0.57 live-cluster production claims into this
gate.
