...
> (Phase 5 / 0.51) remain planned and must pass their own accessibility,
...
[0.51 operator-console plan](IMPLEMENTATION_PLAN_0_51.md). This domain plan
...
**Roadmap alignment:** 0.39–0.43 establish the control-plane substrate; 0.51
