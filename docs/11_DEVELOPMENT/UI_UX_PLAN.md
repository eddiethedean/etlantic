...
>
> **Current 0.54 boundary:** The local CLI, generated read-only HTML/diagram
...
> (Phase 5 / 0.57) remain planned and must pass their own accessibility,
...
[0.57 operator-console plan](IMPLEMENTATION_PLAN_0_57.md). This domain plan
...
- propose the component/theme boundary and the reuse contract for the 0.57
  Operator Console;
...
**Roadmap alignment:** local read-only precursor to the 0.57 Operator Console.
...
**Roadmap alignment:** 0.39–0.43 establish the control-plane substrate; 0.57
