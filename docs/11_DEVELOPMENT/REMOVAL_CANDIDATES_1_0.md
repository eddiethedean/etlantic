...
> **Status: Available in ETLantic 0.28.0.** First-wave removals executed in
> 0.26.0; second-wave removals executed in 0.28.0; remaining inventory continues
...
|---|---|---|---|---|
| `REM-ROOT-DEMOTED` | warn-once root aliases in `_DEMOTED_ALIASES` | various | first wave 0.26.0; second wave **removed 0.28.0** (schema_drift + registry); complete by 1.0 | Prefer owning imports. ~53 remain demoted after 0.28.0. |
...
| `REM-RELIABILITY-ROOT` | Reliability declaration types | `etlantic.reliability` | **removed 0.28.0** | Prefer `etlantic.reliability`. |
