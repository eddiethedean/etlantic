...
|---|---|
| [Epic #30](https://github.com/eddiethedean/etlantic/issues/30) refined contract | Use Local portable compiler; state the ADR-fixed candidate, graph, and work-unit ceilings as fixed implementation limits (not user-configurable/default knobs); preserve the 0.50 `null`-for-full or canonical `selected_nodes` plus sliced-graph representation |
...
| [Story #31](https://github.com/eddiethedean/etlantic/issues/31), [story #37](https://github.com/eddiethedean/etlantic/issues/37), [task #65](https://github.com/eddiethedean/etlantic/issues/65), and [task #69](https://github.com/eddiethedean/etlantic/issues/69) | State the exact 0.50 `null`-for-full or canonical `selected_nodes` plus sliced-graph representation; do not substitute generic dependency-closure wording |
| [Story #38](https://github.com/eddiethedean/etlantic/issues/38), [task #58](https://github.com/eddiethedean/etlantic/issues/58), and [task #74](https://github.com/eddiethedean/etlantic/issues/74) | Retain every bounded target alternative per node; apply the eight-item limit only to supporting evidence inside each node-target record, never to the alternative set |
| [Task #91](https://github.com/eddiethedean/etlantic/issues/91) | Define `PMADP306` using deterministic canonical byte accounting; record peak RSS only as non-normative measured release evidence that cannot influence the selected assignment |
