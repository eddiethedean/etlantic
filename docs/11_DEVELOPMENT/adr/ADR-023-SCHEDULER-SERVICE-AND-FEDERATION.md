...
[0.57](../IMPLEMENTATION_PLAN_0_57.md).
...
Experimental skips. Production hardening is 0.57.
...
| Make live Kind/Databricks a 0.47 blocker | Collides with 0.57 packs; 0.46 used fakes + live skips |
...
- [IMPLEMENTATION_PLAN_0_57](../IMPLEMENTATION_PLAN_0_57.md)
- [ADR-018](ADR-018-DURABLE-SUBMISSION-AND-STATE.md)
