...
[0.58](../IMPLEMENTATION_PLAN_0_58.md).
...
Experimental skips. Production hardening is 0.58.
...
| Make live Kind/Databricks a 0.47 blocker | Collides with 0.58 packs; 0.46 used fakes + live skips |
...
- [IMPLEMENTATION_PLAN_0_58](../IMPLEMENTATION_PLAN_0_58.md)
- [ADR-018](ADR-018-DURABLE-SUBMISSION-AND-STATE.md)
