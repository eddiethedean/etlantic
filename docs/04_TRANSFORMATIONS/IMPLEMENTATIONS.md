...
(0.12 = Polars kernel; **0.13 = relational + PySpark shipped**):
...
in 0.12 and relational claims (Polars + PySpark) ship in 0.13. Native
`@implementation()` registration remains required for engines/profiles a
compiler has not yet claimed. See
