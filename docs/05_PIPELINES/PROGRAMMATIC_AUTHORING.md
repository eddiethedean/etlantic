...
> **Status: ETLantic 0.51.0 release candidate; publication pending** (introduced in 0.24).
...
After `pip install 'etlantic==0.51.0'`, you can build, write JSON, and validate
