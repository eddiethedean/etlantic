"""Cross-artifact 0.24 → 0.25 codec burn-in matrix (WP2)."""
...
def test_plan_old_reader_new_writer() -> None:
...
def test_run_report_old_reader_new_writer() -> None:
...
def test_profile_json_round_trip() -> None:
    data = _load("profile/v0_24/development_local.json")
...
def test_capabilities_vocabulary_round_trip() -> None:
    data = _load("capabilities/v0_24/local_dataframe.json")
