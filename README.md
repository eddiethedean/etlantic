...
<p align="center">
  <a href="https://etlantic.readthedocs.io/en/v0.44.0/01_GETTING_STARTED/QUICKSTART/">Quickstart</a> ·
  <a href="https://etlantic.readthedocs.io/">Documentation</a> ·
  <a href="https://etlantic.readthedocs.io/en/v0.44.0/01_GETTING_STARTED/COMPARE/">Is ETLantic for me?</a> ·
  <a href="https://etlantic.readthedocs.io/en/v0.44.0/10_REFERENCE/API_REFERENCE/">Python API</a> ·
  <a href="https://etlantic.readthedocs.io/en/v0.44.0/10_REFERENCE/CLI/">CLI</a>
</p>
...
[full Quickstart](https://etlantic.readthedocs.io/en/v0.44.0/01_GETTING_STARTED/QUICKSTART/)
...
- Contract generation for
  [ODCS](https://etlantic.readthedocs.io/en/v0.44.0/03_DATA_CONTRACTS/ODCS/),
  [DTCS](https://etlantic.readthedocs.io/en/v0.44.0/04_TRANSFORMATIONS/DTCS/),
  and [DPCS](https://etlantic.readthedocs.io/en/v0.44.0/05_PIPELINES/DPCS/)
  artifacts.
...
[engine selection](https://etlantic.readthedocs.io/en/v0.44.0/01_GETTING_STARTED/ENGINE_SELECTION/)
and
...
is tracked in the
[control-plane program](https://etlantic.readthedocs.io/en/v0.44.0/11_DEVELOPMENT/MULTI_TENANT_CONTROL_PLANE_PLAN/).
...
Review the
[production readiness](https://etlantic.readthedocs.io/en/v0.44.0/06_EXECUTION/PRODUCTION_READINESS/)
and
[security model](https://etlantic.readthedocs.io/en/v0.44.0/02_FOUNDATIONS/SECURITY/)
before a pilot.

## Learn more

- [Quickstart](https://etlantic.readthedocs.io/en/v0.44.0/01_GETTING_STARTED/QUICKSTART/)
  and [first pipeline](https://etlantic.readthedocs.io/en/v0.44.0/01_GETTING_STARTED/FIRST_PIPELINE/)
- [Is ETLantic for me?](https://etlantic.readthedocs.io/en/v0.44.0/01_GETTING_STARTED/COMPARE/)
  and [capabilities](https://etlantic.readthedocs.io/en/v0.44.0/01_GETTING_STARTED/CAPABILITIES/)
- [CLI reference](https://etlantic.readthedocs.io/en/v0.44.0/10_REFERENCE/CLI/)
  and [Python API](https://etlantic.readthedocs.io/en/v0.44.0/10_REFERENCE/API_REFERENCE/)
- [Plugin SDK](https://etlantic.readthedocs.io/en/v0.44.0/07_PLUGIN_SDK/)
  and [optional packages](https://etlantic.readthedocs.io/en/v0.44.0/10_REFERENCE/OPTIONAL_PACKAGES/)
