...
> **Status:** ETLantic **0.26.0** is a **Beta** (PyPI) release suitable for
...
| FastAPI | `etlantic-fastapi` | Thin 0.26 authoring/service **reference** adapter (not the 1.1 control plane) |
