...
version as core (`etlantic-polars==0.52.0` with `etlantic==0.52.0`). Mixed
...
published release until 0.52.0 is tagged. The immutable 0.52.0 tree will be at
[v0.52.0](https://etlantic.readthedocs.io/en/v0.52.0/).
