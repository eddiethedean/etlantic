...
<p align="center">
  <a href="https://etlantic.readthedocs.io/en/v0.37.0/01_GETTING_STARTED/QUICKSTART/">Quickstart</a> ·
  <a href="https://etlantic.readthedocs.io/">Documentation</a> ·
  <a href="https://etlantic.readthedocs.io/en/v0.37.0/01_GETTING_STARTED/COMPARE/">Is ETLantic for me?</a> ·
  <a href="https://etlantic.readthedocs.io/en/v0.37.0/10_REFERENCE/API_REFERENCE/">Python API</a> ·
  <a href="https://etlantic.readthedocs.io/en/v0.37.0/10_REFERENCE/CLI/">CLI</a>
</p>
...
[Quickstart](https://etlantic.readthedocs.io/en/v0.37.0/01_GETTING_STARTED/QUICKSTART/)
to see ETLantic reject an incompatible contract before a write, then build
[your first transformation](https://etlantic.readthedocs.io/en/v0.37.0/01_GETTING_STARTED/FIRST_PIPELINE/).
...
Read the full
[comparison guide](https://etlantic.readthedocs.io/en/v0.37.0/01_GETTING_STARTED/COMPARE/)
...
capability shipped in 0.37, not future roadmap intent.

| Capability | 0.37 | Install |
|---|---|---|
...
tested release. See
[engine selection](https://etlantic.readthedocs.io/en/v0.37.0/01_GETTING_STARTED/ENGINE_SELECTION/),
[compatibility](https://etlantic.readthedocs.io/en/v0.37.0/10_REFERENCE/COMPATIBILITY/),
and
...
then use the
[SDK tutorial](https://etlantic.readthedocs.io/en/v0.37.0/01_GETTING_STARTED/SDK_10_MINUTES/)
or
[programmatic authoring guide](https://etlantic.readthedocs.io/en/v0.37.0/05_PIPELINES/PROGRAMMATIC_AUTHORING/).
...
[Open Data Contract Standard (ODCS)](https://etlantic.readthedocs.io/en/v0.37.0/03_DATA_CONTRACTS/ODCS/),
[Data Transformation Contract Standard (DTCS)](https://etlantic.readthedocs.io/en/v0.37.0/04_TRANSFORMATIONS/DTCS/),
and
[Data Pipeline Contract Standard (DPCS)](https://etlantic.readthedocs.io/en/v0.37.0/05_PIPELINES/DPCS/).
...
- [Capabilities and limitations](https://etlantic.readthedocs.io/en/v0.37.0/01_GETTING_STARTED/CAPABILITIES/)
- [Production readiness](https://etlantic.readthedocs.io/en/v0.37.0/06_EXECUTION/PRODUCTION_READINESS/)
- [Security model](https://etlantic.readthedocs.io/en/v0.37.0/02_FOUNDATIONS/SECURITY/)
- [Enterprise evaluation guide](https://etlantic.readthedocs.io/en/v0.37.0/01_GETTING_STARTED/ENTERPRISE_EVALUATION/)
- [Planned multi-tenant control-plane program](https://etlantic.readthedocs.io/en/v0.37.0/11_DEVELOPMENT/MULTI_TENANT_CONTROL_PLANE_PLAN/)
...
[CLI reference](https://etlantic.readthedocs.io/en/v0.37.0/10_REFERENCE/CLI/)
...
| Goal | Start here |
|---|---|
| Get a first success | [Quickstart](https://etlantic.readthedocs.io/en/v0.37.0/01_GETTING_STARTED/QUICKSTART/) |
| Decide whether ETLantic fits | [Compare](https://etlantic.readthedocs.io/en/v0.37.0/01_GETTING_STARTED/COMPARE/) |
| Choose an engine | [Engine selection](https://etlantic.readthedocs.io/en/v0.37.0/01_GETTING_STARTED/ENGINE_SELECTION/) |
| Learn the architecture | [Architecture](https://etlantic.readthedocs.io/en/v0.37.0/02_FOUNDATIONS/ARCHITECTURE/) |
| Use the Python SDK | [API reference](https://etlantic.readthedocs.io/en/v0.37.0/10_REFERENCE/API_REFERENCE/) |
| Operate a controlled pilot | [Production readiness](https://etlantic.readthedocs.io/en/v0.37.0/06_EXECUTION/PRODUCTION_READINESS/) |
| Review future direction | [Planning Hub](https://etlantic.readthedocs.io/en/v0.37.0/11_DEVELOPMENT/PLAN_INDEX/) |
| Build a plugin | [Plugin SDK](https://etlantic.readthedocs.io/en/v0.37.0/07_PLUGIN_SDK/) |
| Troubleshoot a failure | [Troubleshooting](https://etlantic.readthedocs.io/en/v0.37.0/01_GETTING_STARTED/TROUBLESHOOTING/) |
| Upgrade safely | [Upgrade hub](https://etlantic.readthedocs.io/en/v0.37.0/01_GETTING_STARTED/UPGRADE/) |
